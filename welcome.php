          ...
          <div class="row ">
            <div class="col-lg-12">
              <div class="aboutbox text-center">
                ...
                <h4 id="text"> Upload the image of list items</h4>
              </div>
            </div>
            <div class="col">
              <div class="uploadbox">
                <center>
                  <div class="col-lg-8">
                    ...
                    <div class="container">
                      <img src="https://ilinks.io/static/images/img1.webp" width="550px" alt="...">
                      <div class="card-body text-center">
                        <!-- <h5 class="card-title">Upload your list of items</h5> -->
                        <form action="upload.php" method="POST" enctype="multipart/form-data">
                          <input type="file" name="image" class="m-1" required />
